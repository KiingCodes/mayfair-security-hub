...
const contactInfo = [
  ...
  },
  {
    icon: Mail,
    title: "Email Us",
    value: "info@mayfairsecurity.com",
    link: "mailto:info@mayfairsecurity.com",
  },
  {
    icon: MessageCircle,
    title: "WhatsApp",
  ...
  },
  {
    icon: MapPin,
    title: "Head Office",
    value: "123 Security Blvd, Suite 100, Metro City, MC 12345",
  },
  {
    icon: Clock,
    title: "Office Hours",
    value: "Mon-Fri: 8AM-6PM | Emergency: 24/7",
  },
];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90">
              Get in touch for a free security consultation. Our team is available 
            ...
            <div>
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Whether you need immediate security assistance or want to discuss 
                  a custom solution, we're here to help.
                </p>
              </motion.div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <p className={`text-sm ${info.accent ? 'text-accent-foreground/80' : 'text-muted-foreground'}`}>
                      {info.title}
                    </p>
                    {info.link ? (
                      <a 
              ...
              <div className="bg-muted rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      id="service"
                      placeholder="e.g., Armed Guards, Mobile Patrol, Event Security"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We provide security services across the metropolitan area and surrounding regions. 
